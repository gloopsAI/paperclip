...
Release `2026.717.0-gloops.14` image `sha256:cc1273169e31143ab510db9a3c719c9bf19762a767f88c4c039ef3781377c25f` was built from merge `90be60c5445d6a5d3fd42a6c729df45f6b76a605`, passed workflow `29600068804`, and has GitHub build-provenance attestation. It retains the certified execution, repository, credential, WIP, historical-isolation, recovery, non-renewing campaign-deadman, inert activation, plugin orchestration, wake idempotency, observation, and stop boundaries while adding the independently accepted one-use commissioning transaction: exact sixteen-identity roster and protocol validation before and after restart, non-replayable stop semantics, and behavioral fail-closed rollback proof. The release remains a bounded dark-install candidate; it does not itself authorize Paperclip work, agent unpause, provider execution, recurring autonomy, or MTE. Installed deadman and zero-provider startup rehearsals must pass before inert activation, and commissioning still requires a fresh exact-image root-owned approval.
