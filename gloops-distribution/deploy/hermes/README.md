...
Release `2026.803.0-gloops.35` Paperclip image `sha256:09bf3feac584c2d3a7a33b6d3df6cd3b425a5b27c4b72724c35af492d68615b3` was built from merge `b3233636a20790097f6c082b64fc34bbd2065a33`, passed workflow `30779371921` attempt 1, and has GitHub build provenance bound to that digest; mutable tag `sha-b323363` is a discovery aid only. Its Hermes execution image remains `sha256:fd1f8f68f600f8da0c42a38361d7333a8487015ed04ec5e6bcbed8b4bb9cb00b`, retained in the root-only archive whose SHA-256 is `94015a0ba990fe69c027355facddb34450807ba026b2b81d79275887a16d1637`. This release adds a root-owned host exclusive-writer controller with fail-fast holder identity, pre-mutation journaling, hash-chained terminal restore receipts, dead-holder-only reconciliation, and out-of-band edit refusal. It retains the company backlog freeze, explicitly empty readmission, guarded reset path, exact requested-model binding, fail-closed route evidence, broker credential lifecycle recovery, one-run/one-push authority boundary, atomic settlement, and certified recovery and fail-dark boundaries. It is a bounded reliability release and does not itself authorize recurring autonomy, product work, authority widening, or provider fallback outside the Ollama → Grok CLI → Codex policy.
