...
rm -f /etc/paperclip-gloops/ACTIVATION_APPROVED /etc/paperclip-gloops/HERMES_EXECUTION_APPROVED /etc/paperclip-gloops/HERMES_HANDSHAKE_APPROVED /etc/paperclip-gloops/GATE25_CALIBRATION_APPROVED
rm -f \
  /etc/paperclip-gloops/.GATE25_CALIBRATION_APPROVED.* \
  /etc/paperclip-gloops/.github-push-authorization.json.* \
  /etc/paperclip-gloops/.github-push-authorization.sha256.*
