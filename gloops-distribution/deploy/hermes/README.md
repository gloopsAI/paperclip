...
Release `2026.719.0-gloops.29` Paperclip image `sha256:c6cace2d01b45ee22275f4648155c75b72ec7cb0c7c361ddb1a9c48e9db7caa1` was built from merge `d38a769487af8dffc73d3d30b088cc1122a8638c`, passed workflow `29703360368` attempt 1, and has GitHub build-provenance attestation `36066217`; mutable tag `sha-d38a769` is a discovery aid only. Its Hermes execution image remains `sha256:153a30048d122dfe84bc69d7710d9de77544eac7a1073caca77bdaac1e824aca`, retained in the root-only archive whose SHA-256 is `3cc435332944f18ef2e4ad043c152dfb86eaac560b9be4886876450b2e21d4d2`. This release makes broker-mode credential lifecycles truthful and recoverable: new lifecycles contain only the read-only projector credential, legacy dual-role history remains valid, and the one stranded broker receipt can transition only against its exact raw digest, prior release identity, fully verified stop-history chain, and unique successful graceful stop. The transition is deterministic and crash-idempotent across the history/current-receipt write boundary. It retains the truthful zero-work broker topology, one-run/one-push authority boundary, atomic settlement, prepared request acknowledgement, authoritative Hermes route-and-usage receipts, terminal evidence reconciliation, and the certified execution, repository, credential, WIP, historical-isolation, recovery, inert activation, successor campaign identity, and fail-dark boundaries. It is a bounded dark-install candidate and does not itself authorize Paperclip work, agent unpause, provider execution, GitHub mutation, recurring autonomy, or MTE.
