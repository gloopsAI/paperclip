...
rm -f /etc/paperclip-gloops/ACTIVATION_APPROVED
systemctl daemon-reload
systemctl disable --now paperclip.service paperclip-gloops.service 2>/dev/null || true
systemctl mask paperclip-gloops.service 2>/dev/null || true
