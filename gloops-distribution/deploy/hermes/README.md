...
Release `2026.718.0-gloops.19` image `sha256:b054c14950ce9f8f038177b8ad3f451123bd65c8cf9ac1f0b21073ac2e42fbf9` was built from merge `68950a9c3f3abba7e5f6f296533faa2754ebbc93`, passed workflow `29667758569`, and has GitHub build-provenance attestation `35999834`; mutable tag `sha-68950a9` is a discovery aid only. It retains the certified execution, repository, credential, WIP, historical-isolation, recovery, inert activation, exact-topology rehearsal, and fail-dark boundaries while introducing a fresh, non-renewable repair-cell campaign identity. It preserves the expired predecessor epoch as immutable evidence, requires every deadman verifier caller to name the campaign explicitly, advances the issue-creation floor, and keeps the release-pin interlock engaged until this separate digest-bound pin. This release contains the successor proof mechanism; it does not claim that the host rehearsals have run or that Gate 2 is accepted. The release remains a bounded dark-install candidate and does not itself authorize Paperclip work, agent unpause, provider execution, recurring autonomy, or MTE.
