...
Release `2026.718.0-gloops.17` image `sha256:1a7288514fb5de382053644ea09f8901bb5bb3041f93fd252df5cb6f8e11824a` was built from merge `0e4b884f9fdb9872ef26e89045d8a6f7303b2800`, passed workflow `29655523893`, and has GitHub build-provenance attestation `35980461`; mutable tag `sha-0e4b884` is a discovery aid only. It retains the certified execution, repository, credential, WIP, historical-isolation, recovery, non-renewing campaign-deadman, inert activation, plugin orchestration, wake idempotency, observation, stop, one-use commissioning, event-driven plugin-job-retirement, bounded Hermes accounting, and compact-charter commissioning boundaries while adding root-owned interrupted-commissioning recovery. A surviving supported journal now triggers one bounded, idempotent fail-dark recovery attempt, while corrupt or ambiguous journals remain fenced dark and cannot certify backup, restore, or rollback. This release provides the accepted recovery substrate and split rehearsal only; full Gate 2 remains open until the real host commissioner is killed and recovered through the installed unit at every durable phase. The release remains a bounded dark-install candidate; it does not itself authorize Paperclip work, agent unpause, provider execution, recurring autonomy, or MTE.
