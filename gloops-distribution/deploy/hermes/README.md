...
Release `2026.723.0-gloops.31` Paperclip image `sha256:aa09f78bb6299bc6dc0015e18d06e9e9c667853101103d5f9bdb4b651661643e` was built from merge `72b314551b1a87fb6addd328582e6cfc8fbf6ebd`, passed workflow `30050006568` attempt 1, and has GitHub build-provenance attestation `36860748`; mutable tag `sha-72b3145` is a discovery aid only. Its Hermes execution image remains `sha256:153a30048d122dfe84bc69d7710d9de77544eac7a1073caca77bdaac1e824aca`, retained in the root-only archive whose SHA-256 is `3cc435332944f18ef2e4ad043c152dfb86eaac560b9be4886876450b2e21d4d2`. This release preserves exact requested-model binding and fail-closed route evidence while accepting only the provider-signed canonical Ollama Cloud form of a requested `:cloud` alias. It records requested and resolved model truth in the terminal route receipt and exposes Hermes' installed Agent Skills alongside the bounded terminal tool in the production API profile. It retains broker-mode credential lifecycle recovery, the truthful zero-work broker topology, one-run/one-push authority boundary, atomic settlement, prepared request acknowledgement, authoritative Hermes route-and-usage receipts, terminal evidence reconciliation, and the certified execution, repository, credential, WIP, historical-isolation, recovery, inert activation, successor campaign identity, and fail-dark boundaries. It is a bounded release candidate and does not itself authorize recurring autonomy, authority widening, or provider fallback outside the Ollama → Grok CLI → Codex policy.

Hermes execution image `sha256:210427ae7dc5b61f37aad0c0df5083018bb9c1de04cf9affde645a74988d64ab` preserves the live charter-pack, capacity-allocation, and terminal-reconciliation work while adding compatibility between the existing authoritative route-receipt boundary and Hermes' native `moa` virtual provider. It admits a native MoA preset only when the acting model and every reference model resolve to the subscription-included Ollama Cloud provider, records the real acting route, and includes Hermes' native reference usage in the terminal usage receipt without consuming or resetting the gateway's accounting state. The root-only archive is `hermes-execution-210427ae7dc5b61f37aad0c0df5083018bb9c1de04cf9affde645a74988d64ab.tar.zst` with SHA-256 `9447db763a51d6f69613b985d749a1bcdd4b04624344813027c2fc925510c83d`.
