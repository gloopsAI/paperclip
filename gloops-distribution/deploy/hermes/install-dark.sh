...
install -m 0555 -o root -g root "${SCRIPT_DIR}/verify-backlog-readmit-window.py" "${LIB_DIR}/verify-backlog-readmit-window.py"
...
install -m 0755 -o root -g root "${SCRIPT_DIR}/activate-controlled-swarm-runtime.sh" "${LIB_DIR}/activate-controlled-swarm-runtime.sh"
...
install -m 0555 -o root -g root "${SCRIPT_DIR}/paperclip-hostctl.py" "${LIB_DIR}/paperclip-hostctl.py"
...
install -m 0555 -o root -g root "${SCRIPT_DIR}/rehearse-hermes-cancel-containment.py" "${LIB_DIR}/rehearse-hermes-cancel-containment.py"
...
install -m 0644 -o root -g root "${SCRIPT_DIR}/paperclip-github-webhook-receiver.service" /usr/local/lib/systemd/system/paperclip-github-webhook-receiver.service
...
systemctl disable --now paperclip-controlled-swarm.service 2>/dev/null || true
...
systemctl disable --now paperclip-platform-ops-broker.service 2>/dev/null || true
