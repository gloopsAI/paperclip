...
Release `2026.717.0-gloops.12` image `sha256:bfd94c5e90487cc8ada1504e778fe460ee720a1be7c67205c39e9390cd6077ff` was built from merge `db2e9b209cba7390bc91592ddca1417cbea72138`, passed workflow `29569942076`, and has GitHub build-provenance attestation. It retains the certified execution, repository, credential, WIP, historical-isolation, recovery, and non-renewing campaign-deadman boundaries while adding independently accepted one-use artifact-bound inert activation, an application-level commissioning barrier, root-only observation and stop controls, and installed accelerated deadman proof whose receipt is emitted only after cleanup and final-dark verification. The release remains a bounded dark-install candidate; it does not authorize Paperclip work, agent unpause, provider execution, recurring autonomy, or MTE. Installed deadman and zero-provider startup rehearsals must pass before inert activation, and a separate independently reviewed commissioning slice remains required before the controlled-swarm campaign may execute work.
