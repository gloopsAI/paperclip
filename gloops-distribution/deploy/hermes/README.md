...
Release `2026.717.0-gloops.13` image `sha256:07eb68e29e97059e66481c7e4dc008253f4240ec7f00b9a03e0f13ca32c494fe` was built from merge `f440085b1bd6249f7cd751e21ae93a933195d45f`, passed workflow `29585119804`, and has GitHub build-provenance attestation. It retains the certified execution, repository, credential, WIP, historical-isolation, recovery, non-renewing campaign-deadman, inert activation, commissioning, observation, and stop boundaries while adding independently accepted transactional plugin issue creation, host-observed route provenance, and durable idempotent wake replay across queued, skipped, deferred, coalesced, and rejected outcomes. The release remains a bounded dark-install candidate; it does not authorize Paperclip work, agent unpause, provider execution, recurring autonomy, or MTE. Installed deadman and zero-provider startup rehearsals must pass before inert activation, and a separate independently reviewed commissioning slice remains required before the controlled-swarm campaign may execute work.
