...
Release `2026.719.0-gloops.21` image `sha256:c6d6856b0d875f7f824a40b1e1d087af4bf286b957ec0eecef79e7c11a35e39f` was built from merge `2d189c87dd4766a99b53095a215274b979458c68`, passed workflow `29672760564`, and has GitHub build-provenance attestation `36013123`; mutable tag `sha-2d189c8` is a discovery aid only. It retains the certified execution, repository, credential, WIP, historical-isolation, recovery, inert activation, exact-topology rehearsal, successor campaign identity, and fail-dark boundaries while treating a healthy unit's nonzero `reset-failed` result as best-effort cleanup. The actual Paperclip recovery restart remains checked. This release contains the narrow recovery correction; it does not claim that the host rehearsals have run or that Gate 2 is accepted. The release remains a bounded dark-install candidate and does not itself authorize Paperclip work, agent unpause, provider execution, recurring autonomy, or MTE.
